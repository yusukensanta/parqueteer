...
> **Note:** Entries below cover notable feature work through v0.4.1. Every tagged
> release (current: see [releases](https://github.com/yusukensanta/parqueteer/releases))
> gets auto-generated GitHub release notes from commit history — check there for the
> full, up-to-date changelog.
