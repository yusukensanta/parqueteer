...
import com.github.yusukensanta.parqueteer.core.services.ParquetService
import com.github.yusukensanta.parqueteer.core.repositories.ParquetRepository
import com.github.yusukensanta.parqueteer.core.models.{ReadConfig, WriteConfig}
import com.github.yusukensanta.parqueteer.config.ConfigurationManager
...
object CliApp {
  ...
  private def executeRead(
      ...
      format: com.github.yusukensanta.parqueteer.core.models.OutputFormat,
      globalOptions: GlobalOptions
  ): Int = {
  ...
  private def executeWrite(
      ...
      inputPath: String,
      inputFormat: String,
      compression: com.github.yusukensanta.parqueteer.core.models.CompressionType,
  ...
  private def executeConvert(
    ...
    val conversionConfig =
      com.github.yusukensanta.parqueteer.core.services.ConversionConfig(
  ...
  private def setupLogging(
      loggingConfig: com.github.yusukensanta.parqueteer.config.LoggingConfig,
      verbose: Boolean
  ): Unit = {
