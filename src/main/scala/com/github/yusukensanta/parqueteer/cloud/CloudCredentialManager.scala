package com.github.yusukensanta.parqueteer.cloud

import com.github.yusukensanta.parqueteer.core.models.StorageLocation
...
object CloudCredentialManager {
  ...
  def forLocation(location: StorageLocation): Option[CloudCredentialManager] = {
    location match {
      case _: com.github.yusukensanta.parqueteer.core.models.S3Location =>
        Some(new S3CredentialManager)
      case _: com.github.yusukensanta.parqueteer.core.models.GCSLocation =>
        Some(new GCSCredentialManager)
      case _: com.github.yusukensanta.parqueteer.core.models.AzureLocation =>
        Some(new AzureCredentialManager)
      case _: com.github.yusukensanta.parqueteer.core.models.LocalPath => None
    }
  }
}
