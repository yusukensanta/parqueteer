package com.github.yusukensanta.parqueteer.core.services

import com.github.yusukensanta.parqueteer.core.models._
import com.github.yusukensanta.parqueteer.core.models.StorageLocationParser
...
class ParquetService(
  ...
  private def formatContentAsJSON(content: FileContent): String = {
    import com.github.yusukensanta.parqueteer.core.formatters.JSONFormatter
    new JSONFormatter().formatContent(content, None)
  }

  private def formatContentAsCSV(content: FileContent): String = {
    import com.github.yusukensanta.parqueteer.core.formatters.CSVFormatter
  ...
  def formatContent(file: ParquetFile, format: OutputFormat): String = {
    import com.github.yusukensanta.parqueteer.core.formatters.OutputFormatter
